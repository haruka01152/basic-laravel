<div class="bg-white border-t border-b border-solid border-gray-300 shadow-lg hidden sm:block">
        <div class="container flex justify-between max-w-7xl mx-auto px-4 lg:px-8">
            ...
            <a class="hover:bg-gray-200 inline-block py-3 w-48 text-center border-r border-l border-gray-300" href="{{route('log')}}">商品変更履歴</a>
            ...
            <a class="hover:bg-gray-200 inline-block py-3 w-48 text-center border-r border-l border-gray-300" href="{{route('mypage')}}">マイページ</a>
        </div>
    </div>